...
const statusConfig: Record<SipStatus, { icon: LucideIcon; colorClass: string; label: string }> = {
  ...
  Final: { icon: Award, colorClass: 'bg-teal-500 hover:bg-teal-600', label: 'Final' },
  ...
  "Closed (unmerged)": { icon: ArchiveX, colorClass: 'bg-orange-500 hover:bg-orange-600', label: 'Closed (Unmerged)' },
};
